...
var SimulationStatusComponent = (function () {
    function SimulationStatusComponent(arcologyService) {
        this.arcologyService = arcologyService;
    }
    SimulationStatusComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.arcologyService.getStatus()
            .subscribe(function (status) { return _this.isTerminated = status.isTerminated; });
    };
    return SimulationStatusComponent;
}());
SimulationStatusComponent = __decorate([
    core_1.Component({
...
exports.SimulationStatusComponent = SimulationStatusComponent;
//# sourceMappingURL=simulation-status.component.js.map